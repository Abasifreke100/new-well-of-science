...
export default function HeroSection() {
  return (
    ...
    100vw"
      ...
      <div className="container relative z-40 flex flex-col-reverse w-full gap-8 lg:flex-row lg:items-center md:gap-6 lg:gap-40">
        <div className="flex flex-col lg:justify-between md:max-w-[26.9375rem] lg:max-w-[22.4375rem]">
