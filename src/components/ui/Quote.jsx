  ...
  return (
    <SectionPadding>
        <motion.div 
            ...
            transition={{
                duration:0.5,
            }} className=' py-20 md:py-36 px-10 md:px-48 rounded-[100px] bg-[#3D3D3D] mb-9 text-white text-center text-[20px] md:text-[24px] sm:text-[32px]  flex flex-col justify-center items-center relative  '>
            ...
            <motion.p 
                ...
                className='font-inter text-[14px] md:text-[28px]'
                >
            ...
            <div className='flex flex-col content-center my-5 mt-10 '>
                ...
                <h3 className='capitalize text-center text-sm md:text-base '>The Well Of science</h3>
            </div>
