...
const EnquiriesForm = () => {
  ...
  return (
    <div className="bg-green_one">
      <motion.div
        className="max-w-lg mx-auto p-8 my-12 bg-white shadow-xl rounded-lg space-y-6"
        ...
        >
          <div className="space-y-2">
            ...
            {formError.institutionType && (
              <span className="text-red-500">{formError.institutionType.message}</span>
            )}
          </div>
          ...
          {institutionType && (
            <>
              ...
              <span className="text-red-500">{formError.institutionName.message}</span>
            )}
              </motion.div>
              <motion.div
                className="space-y-2"
              ...
              >
                ...
                {formError.studentName && (
                  <span className="text-red-500">{formError.studentName.message}</span>
                )}
              </motion.div>
              <motion.div
                className="space-y-2"
              ...
              {formError.studentEmail && (
                  <span className="text-red-500">{formError.studentEmail.message}</span>
                )}
              </motion.div>
              <motion.div
                className="space-y-2"
              ...
              >
                ...
                {formError.studentPhone && (
                  <span className="text-red-500">{formError.studentPhone.message}</span>
                )}
              </motion.div>
              <motion.button
                type="submit"
                className="w-full py-3 px-4 bg-green-500 text-white font-semibold rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-75 mt-4"
