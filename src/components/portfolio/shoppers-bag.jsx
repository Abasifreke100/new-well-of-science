...
export default function ShoppersBag() {
  return (
    <section className="md:px-8 lg:px-20">
      ...
      <div className="rounded-3xl md:rounded-[64px] lg:rounded-[100px] bg-[#276085] px-4 pt-10 pb-20 md:px-10 md:py-20 lg:pt-20 lg:px-20 lg:pb-40 relative mb-10 md:mb-[148px] lg:mb-20">
        <div className="mb-10 md:mb-16">
          <p className="text-[#EBEBEB] font-medium leading-[150%] text-xl md:text-2xl lg:text-[32px] font-gen_sans">
            ShoppersBag is a{" "}
        ...
        <div className="mb-10 md:mb-16">
          <p className="text-[#EBEBEB] leading-[160%] font-medium font-inter text-sm lg:text-base lg:w-[621px]  first-letter:font-gen_sans first-letter:text-[32px]">
