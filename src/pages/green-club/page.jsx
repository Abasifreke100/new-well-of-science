...
const GreenClubPage = () => {
  return (
    <Layout>
      <div className="flex flex-col w-full overflow-hidden font-gen_sans">
        <div className="h-[500px] relative  bg-[url('/images/backgroundgoals.png')]  text-white  bg-cover flex flex-col items-center justify-center text-center">
